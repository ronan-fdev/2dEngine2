...
Renderer::Renderer()
	: m_Lines{}, m_Rects{}, m_Circles{}, m_Text{}, m_pLineBatch{ std::make_unique<LineBatchRenderer>() }, m_pRectBatch{ std::make_unique<RectBatchRenderer>() }, m_pCircleBatch{ std::make_unique<CircleBatchRenderer>() }, m_pSpriteBatch{ std::make_unique<SpriteBatchRenderer>() }, m_pTextBatch{ std::make_unique<TextBatchRenderer>() }
{
}
